...
3. **Raspberry Pi Specifics:**
   ...
   - Runs as systemd service under 'pi' user
   - Uses `/home/pi/` paths (do not hardcode other user paths)
...
The application uses JSON files in `/home/pi/`:
...
- **File permissions**: Ensure proper ownership (pi user)
...
- **Default user**: `pi` (standard Raspberry Pi OS)
- **Installation directory**: `/home/pi/inky-photo-frame/`
- **Photos directory**: `/home/pi/Images/`
- **Configuration files**: `/home/pi/.inky_*`
